...
static ListSelector menu_focal_length(menu_focal_length_desc, &focal, 35, 3 * sizeof(int), 12, menu_focal_length_values);
...
static NamedListSelector menu_pre_shutter(menu_pre_shutter_desc, &pre_shutter, 100, 5 * sizeof(int), 5, menu_pre_shutter_names, menu_pre_shutter_values);

// # of Shots
extern volatile int shots;
static const PROGMEM char menu___of_shots_desc[] = "# of Shots";

static RangeSelector menu___of_shots(menu___of_shots_desc, &shots, 1, 6 * sizeof(int), 1, 5, 1);
...
static const PROGMEM union MenuItem menus[] = {&menu_start, &menu_horiz_fov, &menu_vert_fov, &menu_focal_length, &menu_shutter, &menu_pre_shutter, &menu___of_shots, &menu_aspect, &menu_motors, &menu_display};
